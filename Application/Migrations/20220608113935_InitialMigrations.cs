        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FotoUriId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HolidayDestination", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HolidayDestination_Link_FotoUriId",
                        column: x => x.FotoUriId,
                        principalTable: "Link",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HolidayDestination_FotoUriId",
                table: "HolidayDestination",
                column: "FotoUriId");
